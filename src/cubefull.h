...
const char colorNames[6][7] = { "WHITE", "YELLOW", "RED", "BLUE", "GREEN", "ORANGE" };
...
void searchForCornerStep2(Cube* thisCube, char* corner1, char* corner2, char* corner3, color panel1, color panel2, color panel3)
{
...
void searchForCornerStep3(Cube* thisCube, char* corner1, char* corner2, color panel1, color panel2)
{
    if (!((*corner1) && (*corner2)))
    {
        rotateSideBy90(thisCube, YELLOW);
...
void secondStep(Cube* thisCube)
{
    ...
    if (redcorner)
    {
        ...
        if (bluecorner)
        {
            ...
            char orangecorner = ifCorner(thisCube, ORANGE);
            char greencorner = ifCorner(thisCube, GREEN);
            searchForCornerStep3(thisCube, &orangecorner, &greencorner, ORANGE, GREEN);
        ...
        else if (orangecorner)
        {
            ...
            char bluecorner = ifCorner(thisCube, BLUE);
            char greencorner = ifCorner(thisCube, GREEN);
            searchForCornerStep3(thisCube, &bluecorner, &greencorner, BLUE, GREEN);
        ...
        else if (greencorner)
        {
            ...
            char bluecorner = ifCorner(thisCube, BLUE);
            char orangecorner = ifCorner(thisCube, ORANGE);
            searchForCornerStep3(thisCube, &orangecorner, &bluecorner, ORANGE, BLUE);
    ...
    else if (bluecorner)
    {
        ...
        else if (orangecorner)
        {
            ...
            char redcorner = ifCorner(thisCube, RED);
            char greencorner = ifCorner(thisCube, GREEN);
            searchForCornerStep3(thisCube, &redcorner, &greencorner, RED, GREEN);
        ...
        else if (greencorner)
        {
            ...
            char redcorner = ifCorner(thisCube, RED);
            char orangecorner = ifCorner(thisCube, ORANGE);
            searchForCornerStep3(thisCube, &redcorner, &orangecorner, RED, ORANGE);
    ...
    else if (orangecorner)
    {
        ...
        else if (greencorner)
        {
            ...
            char bluecorner = ifCorner(thisCube, BLUE);
            char redcorner = ifCorner(thisCube, RED);
            searchForCornerStep3(thisCube, &bluecorner, &redcorner, BLUE, RED);
    ...
    else if (greencorner)
    {
        ...
        if (bluecorner)
        {
            ...
            char redcorner = ifCorner(thisCube, RED);
            char orangecorner = ifCorner(thisCube, ORANGE);
            searchForCornerStep3(thisCube, &orangecorner, &redcorner, ORANGE, RED);
        ...
        else if (orangecorner)
        {
            ...
            char bluecorner = ifCorner(thisCube, BLUE);
            char redcorner = ifCorner(thisCube, RED);
            searchForCornerStep3(thisCube, &redcorner, &bluecorner, RED, BLUE);
